(function () {
  ...
  grid.addEventListener("click", function (event) {
    ...
    // opaque public_id, never the IMDb tconst. See _watchlist_card.html.
    ...
    fetch("/watchlist/remove/" + encodeURIComponent(publicId), {
      method: "POST",
      ...
      .then(function (response) {
        ...
        setTimeout(function () {
          ...
          showToast("Removed from watchlist", function () {
            ...
            fetch("/watchlist/add/" + encodeURIComponent(lastRemoved.publicId), {
              method: "POST",
              headers: { "X-CSRFToken": csrfToken, Accept: "application/json" },
              credentials: "same-origin",
            }).catch(function (err) {
